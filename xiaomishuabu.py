...
def main(user, passwd, step):
    ...
    if step == '':
        print("已设置为随机步数（15000-30000）")
        step = str(random.randint(15000, 30000))
    if user == '15820177887':
        step = str(random.randint(30000, 40000))   
    if user == '13686708081':
        step = str(random.randint(25000, 35000))   
    login_token = 0
...
def start():
    ...
    user = "15917100217#13727709069#15820177887#13692583426#13686708081"
    # 这里输入登录密码
    passwd = "Fai0123456#aa123456#oppof15mliw366#kk920328#HJH2889951"
